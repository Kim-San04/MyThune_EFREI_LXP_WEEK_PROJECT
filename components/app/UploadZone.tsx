...
import { ArrowLeft, FileText, ShieldCheck, Sparkles, UploadCloud } from "lucide-react";
...
export default function UploadZone({ onFileSelected, onCancel }: UploadZoneProps) {
    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-16">
      ...
      >
        {onCancel && (
          <button
            onClick={onCancel}
            className="flex items-center gap-2 text-sm font-semibold text-ink-soft hover:text-coral transition-colors mb-6"
          >
        ...
        <div className="text-center mb-10">
          ...
          <p className="font-body text-ink-mid max-w-md mx-auto leading-relaxed">
            ...
            Thunie le lit, le trie par catégorie et te prépare ton tableau de bord.
          </p>
        </div>
